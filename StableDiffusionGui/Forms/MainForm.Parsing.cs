    ...
    public partial class MainForm
    {
        ...
        public TtiSettings GetCurrentTtiSettings()
        {
            TtiSettings settings = new TtiSettings
            {
                ...
                RefinerStrengths = panelRefineStart.Visible ? MainUi.GetExtraValues(textboxExtraRefinerValues.Text, sliderRefinerStart.ActualValueFloat).ToArray() : new float[0],
                ...
                InitStrengths = panelInitImgStrength.Visible ? MainUi.GetExtraValues(textboxExtraInitStrengths.Text, sliderInitStrength.ActualValueFloat).ToArray() : new float[0],
